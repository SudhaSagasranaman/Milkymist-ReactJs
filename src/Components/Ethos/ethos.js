                ...
                <div className="row">
                    <div className="col-12 col-sm-12 col-lg-4 col-md-4">
                        <div className="card fw-bold text-white" >
                            ...
                            <div className="card-img-overlay">
                                <p className="card-text card-hover-text">The aroma of Milky Mist Ghee makes every Onam Sadya irresistible.So rich, even Mahabali would pause for another serving.
                                    ✨🏵 Celebrate the season with flavour as grand as the festival itself!</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-sm-12 col-lg-4 col-md-4">
                        <div className="card fw-bold text-tertiary">
                            ...
                            <div className="card-img-overlay">
                                ...
                                <p className="card-text card-hover-text">This Ganesh Chaturthi, we celebrate tradition, devotion, and the joy of togetherness. ✨

                                    With the richness of Milky Mist Ghee, every festive sweet is crafted to perfection, bringing purity, taste, and trust to every household.

                                    Wishing you and your family a blessed Ganesh Chaturth.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-sm-12 col-lg-4 col-md-4">
                        ...
                        <iframe
                            ...
                            title="Taste the Milky Mist Ice Cream | Milky Mist Ice Cream TVC | 2024 | Tamil"
