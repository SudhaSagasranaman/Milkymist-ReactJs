...
export function Updates(){
 return(
  ...
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAsHX9TBlbNWsYJKccHGx7v5QgSZPORishCA&s" className="card-img-top" alt="..."/>
  ...
  <img src="https://static.wixstatic.com/media/60b717_0f26f7779224408c89d60ea35730da10~mv2.png/v1/fill/w_2400,h_1254,al_c/60b717_0f26f7779224408c89d60ea35730da10~mv2.png" className="card-img-top" alt="..."/>
  <button className = "position-absolute bottom-0 start-50 translate-middle-x btn btn-primary text-center rounded-pill smallFont ">New launch</button>
  </div>
  <div className ="card-body">
...
Introducing our Coffee and Butterscotch milkshake variants—the ultimate pick-me-up for your day! Guaranteed to keep you refreshed all day, indulge in pure delight with every sip.
  ...
  <img src="https://static.wixstatic.com/media/60b717_a11afdb6d1a6488b97206daf44e81d7c~mv2.png/v1/fill/w_2400,h_1254,al_c/60b717_a11afdb6d1a6488b97206daf44e81d7c~mv2.png" className="card-img-top" alt="..."/>
  <button className = "position-absolute bottom-0 start-50 translate-middle-x btn btn-primary text-center rounded-pill smallFont ">New launch</button>
  </div>
  <div className="card-body">
...
Introducing Capella, our exceptional assortment of chocolate delights. Immerse yourself in the rich velvety goodness that promises to delight your taste buds with every bite.
  ...
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnNB__A8eo8ZEeUquc7AOHIVWvUL6pTRaTOQ&s" className="card-img-top" alt="..."/>
  <button className = "position-absolute bottom-0 start-50 translate-middle-x btn btn-primary text-center rounded-pill smallFont ">New launch</button>
  </div>
  <div className="card-body">
...
Introducing our new Greek yogurt blend: creamy, probiotic-packed, with honey and figs for a sweet, healthy start to your day!
  ...
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXYdPgnuCsaMUxFBkD-UyZHHnZljR4UuLhRKxF-o9qNANlGU8bBUWQ2NhliracGUwQSNE&usqp=CAU" className="card-img-top" alt="..."/>
  <button className = "position-absolute bottom-0 start-50 translate-middle-x btn btn-primary text-center rounded-pill smallFont ">New launch</button>
  </div>
  <div className ="card-body">
